...
const FAQ = () => {
    return (
        <section className=" relative z-20 overflow-hidden bg-sky-900 pb-12 pt-20 lg:pb-[90px] lg:pt-[120px]">
            <div className="container mx-auto">
                <div className="-mx-4 flex flex-wrap">
                    <div className="w-full px-4">
                        <div className="mx-auto mb-[60px] max-w-[520px] text-center lg:mb-20">
                            <span className="mb-2 block text-lg font-semibold text-sky-300">
                                FAQ
                            </span>
                            <h2 className="mb-4 text-3xl font-bold text-white sm:text-[40px]/[48px]">
                                Any Questions? Look Here
                            </h2>
                            <p className="text-sky-300 text-body-color">
...
const FAQItem = ({ header, text }) => {
    ...
    return (
        <div className="mx-16 mb-8 rounded-lg bg-white p-4 shadow-[0px_20px_95px_0px_rgba(201,203,204,0.30)] sm:p-8 lg:px-6 xl:px-8">
            <button
            ...
            >
                <p className="p-3 bg-base-200 text-base leading-relaxed text-body-color">
                    {text}
                </p>
            </div>
        </div>
